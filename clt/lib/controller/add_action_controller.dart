import 'package:clt/models/add_action_model.dart';
...
class AddActionController {
  ...
  static void githubLabel(String repoID, String owner, God god) =>
      AddActionModel().githubCreateLabelActionCreate(repoID, owner, god);

  static void githubMilestone(String repoID, String owner, God god) =>
      AddActionModel().githubCreateMilestoneActionCreate(repoID, owner, god);

  static void githubPullRequest(String repoID, String owner, God god) =>
      AddActionModel().githubCreatePullRequestActionCreate(repoID, owner, god);

  static void githubPush(String repoID, String owner, God god) =>
      AddActionModel().githubCreatePushActionCreate(repoID, owner, god);

  static void githubIssue(String repoID, String owner, God god) =>
