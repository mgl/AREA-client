...
class _ActionGithubPullRequestReactionPageState
    extends State<ActionGithubPullRequestReactionPage> {
    ...
    for (int i = 0;
      ...
      if (widget.god.globalContainer.actionGithubPullRequest[i].id ==
        ...
        reactionGoogleCalendarEvent =
            widget.god.globalContainer.actionGithubPullRequest[i].reactionMail;
