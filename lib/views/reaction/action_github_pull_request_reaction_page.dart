...
class ActionGithubPullRequestReactionPage extends StatefulWidget {
  const ActionGithubPullRequestReactionPage({ Key? key, required this.id }) : super(key: key);

  final String id;

  @override
  State<ActionGithubPullRequestReactionPage> createState() => _ActionGithubPullRequestReactionPageState();
}

class _ActionGithubPullRequestReactionPageState extends State<ActionGithubPullRequestReactionPage> {
  ...
  void getReaction() {
    for (int i = 0;
        i < globalContainer.actionGithubPullRequest.length;
        i++) {
